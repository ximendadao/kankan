...
function getpwd(q,verifycode,pwd){
    // q = "tEeq0+eSCC1gZabTc1C2BWZdlhWQMCG3TQDQMNyD39wINtWgs46m0Ty/W/U7rf9DuBLkvoHmDj0XSb/OfT2Fcolq/F90YHUZ1JUDepiloRB37Q3Wmq1IrOMNaD6f49DmTU2j/CrIicOLLjC/fyB4ZDjPwBstepvffqBZ/q0Ni2s=";
    l = 'AQAB';
    var r = new RSAKey;
    r.setPublic(b64tohex(q), b64tohex(l));
    var z = verifycode.toUpperCase();
    r = hex2b64(r.encrypt(md5(pwd) + z));
    return r
}
